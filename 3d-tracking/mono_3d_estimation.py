...
# --resume ./checkpoint/{CKPT} \  #'{}_{}_checkpoint_{}.pth.tar'
# --json_path {JSON} \  # bdd_json
# --track_name {TRK} \  # a new file save in /{SESS}_{EP}_{SET}_{SPLIT}_set/
# --is_tracking \
# --is_normalizing \
# --session {SESS} {FLAG} --start_epoch {EPOCH}'  # flag for runnning evaluate code
